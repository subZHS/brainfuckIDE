...
public class NewaFileFrame extends JFrame {

	JFrame newFileFrame;
	JButton ensureButton, cancelButton;
	JTextField filenameField;
	private static NewaFileFrame newaFileFrame = new NewaFileFrame();

	private NewaFileFrame() {
	}

	public static NewaFileFrame getInstance() {
		return newaFileFrame;
	}
	...
	class ensureButtonActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (filename.equals("filename") || filename.equals("") || filename.equals("failed. try again")) {
				...
				String userId = MyFrame.getInstance().usernamelabel.getText();
				...
				if (!issuccess) {
					...
					MyFrame.getInstance().filenamelabel.setText(filename);
					MyFrame.getInstance().codeArea.setEditable(true);
					MyFrame.getInstance().inputArea.setEditable(true);
